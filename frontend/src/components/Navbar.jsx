...
export default function Navbar() {
    ...
    const { isLoggedIn,setLoggedIn ,AccessToken,setAccessToken} = useContext(CreateContext);
                ...
                <div className="justify-between px-4 mx-auto lg:max-w-7xl md:items-center md:flex md:px-8  bg-purple-200">
                    ...
                    <div>
                        ...
                        >
                            ...
                            {!isLoggedIn ? (<div className="mt-3 space-y-2 md:hidden ">
                                <Link
                                    to="/login"
                    ...
                    {!isLoggedIn?(<div className="hidden space-x-2 md:inline-block">
                        <Link
                            to="/login"
